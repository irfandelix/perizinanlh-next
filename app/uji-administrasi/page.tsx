...
import { FileText, CheckCircle, Clock, Loader2, AlertCircle, ChevronRight } from 'lucide-react'; 
        ...
        <div className="min-h-screen bg-slate-50 p-6 md:p-12 font-sans">
            <div className="mb-10 max-w-6xl mx-auto">
                <h1 className="text-3xl font-black text-slate-800 flex items-center gap-4 tracking-tight">
                    <div className="p-3 bg-orange-600 rounded-2xl shadow-xl shadow-orange-100 italic"><FileText className="text-white w-7 h-7" /></div>
                    UJI ADMINISTRASI (TAHAP B)
                </h1>
                <p className="text-slate-400 mt-3 ml-20 text-xs font-black uppercase tracking-[0.2em]">Penerbitan Berita Acara Uji Administrasi</p>
            </div>
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-white rounded-[2.5rem] shadow-sm border border-slate-100 overflow-hidden">
                    {loading ? (
                        <div className="flex flex-col items-center justify-center p-24 text-orange-600"><Loader2 className="animate-spin w-12 h-12 mb-4" /><span className="text-xs font-black uppercase tracking-widest text-slate-400">Sinkronisasi Data...</span></div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left text-sm border-collapse">
                                <thead className="bg-slate-50/50 text-slate-400 font-black uppercase text-[10px] tracking-[0.2em] border-b border-slate-50">
                                    <tr><th className="p-6 w-20 text-center">No</th><th className="p-6">Kegiatan & Dokumen</th><th className="p-6">Pemrakarsa</th><th className="p-6 text-center">Status BA</th><th className="p-6 text-center w-40">Aksi</th></tr>
                                </thead>
                                        ...
                                        <tr key={doc._id} className="hover:bg-orange-50/30 transition-all duration-200 group">
                                            ...
                                            <td className="p-6">
                                                <div className="flex flex-col gap-1.5">
                                                    <span className="inline-block w-fit px-2.5 py-0.5 rounded-md text-[9px] font-black bg-orange-50 text-orange-600 uppercase tracking-tighter border border-orange-100">{doc.jenisDokumen}</span>
...
export default function UjiAdministrasiPage() {
    return (
        <Suspense fallback={<div className="min-h-screen flex flex-col items-center justify-center bg-slate-50"><Loader2 className="animate-spin w-12 h-12 text-orange-600 mb-4" /><p className="text-xs font-black text-slate-400 uppercase tracking-widest">Menyiapkan Halaman...</p></div>}>
