...
interface Dokumen {
    ...
    nomorBAPemeriksaan?: string; // Output tahap ini (Wajib diambil dari API)
}
...
export default function PemeriksaanSubstansiPage() {
    ...
    const fetchData = async () => {
        ...
        try {
            ...
            if (result.success) {
                // FILTER: Hanya tampilkan yang sudah lulus Verifikasi Lapangan (Punya No BA Verlap)
                                ...
                                {loading ? (
                                    ...
                                    dataDokumen.map((doc, index) => (
                                        <tr key={index} className="hover:bg-gray-50 transition-colors">
                                            ...
                                            {/* KOLOM 3: HASIL (NO BA PEMERIKSAAN) */}
                                            <td className="px-6 py-4">
